...
resource "cdnetworks_waap_ratelimit_v2" "demo" {
...
data "cdnetworks_waap_ratelimits_v2" "demo" {
  domain_list = [cdnetworks_waap_ratelimit_v2.demo.domain]
}

output "waap_ratelimit_v2" {
  value = data.cdnetworks_waap_ratelimits_v2.demo
}
