...
resource "cdnetworks_waap_pre_deploy_rate_limiting_v2" "demo" {
...
output "cdnetworks_waap_pre_deploy_rate_limiting_v2_result" {
  value = cdnetworks_waap_pre_deploy_rate_limiting_v2.demo.host_list
}
