...
- `operators_area` (String) Region. multiple separated by semicolons, such as CN;US. For the range of values, see Section 4, “Appendixes,” at https://documents.cdnetworks.com/cn/document/api-doc/overview.
- `exceptional_operators_area` (String) Exceptional Region. multiple separated by semicolons, such as CN;US. For the range of values, see Section 4, “Appendixes,” at https://documents.cdnetworks.com/cn/document/api-doc/overview.
