...
- `key_match_wildcard` (String) Whether the response header name matches wildcard.<br/>When match type is NONE, wildcard matching is not supported.<br/>Optional values: TRUE, FALSE.
