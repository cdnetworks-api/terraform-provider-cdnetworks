...
page_title: "cdnetworks_waap_pre_deploy_rate_limiting_v2 Resource - cdnetworks"
subcategory: "Security"
description: |-
    Use this resource to pre-deploy a WAAP rate limiting configuration (v2).
    This resource stages rate limiting rules using the v2 API before they go live, supporting multi-dimensional statistical granularity and IP Blocking action.
---

# cdnetworks_waap_pre_deploy_rate_limiting_v2 (Resource)
...
- `statistical_items` (Block List, Min: 1) Statistical granularity list. (see [below for nested schema](#nestedblock--rule_list--statistical_items))
...
<a id="nestedblock--rule_list--statistical_items"></a>
### Nested Schema for `rule_list.statistical_items`
